...
interface AuthModalProps {
  ...
  parishes: Parish[];
  onLogin: (username: string, password?: string) => { success: boolean; message: string; user?: UserAccount };
...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const roleBadge = (role: UserRole) => {
    switch (role) {
      ...
      case 'council_leader':
        return { label: 'Trưởng Ban Hành Giáo', color: 'bg-amber-100 text-amber-800 border-amber-200' };
      case 'viewer':
      default:
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-5">
            ...
            <div className="space-y-5">
              ...
              <div>
                <h4 className="text-xs font-bold uppercase tracking-wider text-slate-700 mb-2 flex items-center gap-1.5">
                  ...
                  Các Giáo Xứ Bạn Có Quyền Truy Cập ({parishes.filter(p => currentUser.role === 'pastor' || currentUser.parishIds.includes(p.id)).length})
                </h4>
                <div className="space-y-2">
                  {parishes
                    .filter((p) => currentUser.role === 'pastor' || currentUser.parishIds.includes(p.id))
                    .map((p) => (
                      <div
                        key={p.id}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="VD: chaxu, ketoan, thuquy hoặc email..."
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                    />
                    <button
                      type="button"
                  ...
                  {initialUsers.map((u) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          onQuickLogin(u.id);
                          setAuthSuccess(`Đã đăng nhập với tư cách: ${u.fullName}`);
                          setTimeout(() => {
                            onClose();
                            setAuthSuccess(null);
                          }, 600);
                        }}
                        className="p-2.5 text-left rounded-xl border border-slate-200 hover:border-blue-400 hover:bg-blue-50/50 bg-slate-50/50 transition-all flex items-center gap-2.5 group"
                      >
                        <div className="w-8 h-8 rounded-full bg-slate-200 group-hover:bg-blue-600 group-hover:text-white text-slate-700 flex items-center justify-center font-bold text-xs transition-colors shrink-0">
                          {u.saintName ? u.saintName.charAt(0) : u.fullName.charAt(0)}
                        </div>
          ...
          {activeTab === 'register' && (
            <form onSubmit={handleRegisterSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="email@giaophan.vn"
                      className="w-full pl-8 pr-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs focus:bg-white focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    />
                  </div>
                </div>
              ...
              {/* Parish Selection / Creation Section */}
                ...
                <div className="flex items-center gap-4 text-xs font-medium text-slate-700">
                  ...
                  <label className="flex items-center gap-1.5 cursor-pointer">
                    <input
                      ...
                      className="text-blue-600 focus:ring-blue-500"
                    />
                    <span>+ Tạo Giáo xứ mới trên hệ thống</span>
                  </label>
                </div>
                  ...
                  <div className="space-y-2.5 pt-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      <input
                        ...
                        placeholder="Tên Giáo Phận (VD: Tổng Giáo Phận Sài Gòn)..."
                      ...
                      <input
                        ...
                        placeholder="Tên Giáo Hạt (VD: Giáo Hạt Thủ Đức)..."
                        className="w-full px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none"
                      />
                    </div>
                    <input
                    ...
                    <p className="text-[11px] text-blue-700">
                      &bull; Hệ thống sẽ tự động khởi tạo danh mục thu chi chuẩn Công giáo Việt Nam, mẫu quỹ tiền mặt, quỹ xây dựng, quỹ Caritas và các giáo khu cho Giáo xứ mới này.
                    </p>
                  </div>
                )}
              </div>
